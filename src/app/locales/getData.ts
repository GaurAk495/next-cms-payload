...
export const localesHomeData = {
  ...
  es: {
    hero: {
      ...
      title: {
        part1: "El Headless CMS para",
        highlight: "Equipos de Alto Rendimiento",
        part2: "",
      },
      description:
...
export const localeContactData = {
  en: {
    metadata: {
